...
class Contacte {
    ...
    public function toArray() {
        return array("id"=>$this->getId(),"name"=>$this->getName(),"surname"=>$this->getSurname(),"email"=>$this->getEmail(),"phone"=>$this->getPhone());
    }
}
...
class ContacteDB {
	static public function getAll() {
		...
		$result = $stmt->fetchAll();
            return array('code'=>1,'message'=>" query getAll",'result'=>$result);
		}
		catch(Throwable $e) {
